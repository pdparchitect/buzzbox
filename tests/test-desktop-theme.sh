#!/bin/bash
# Buzzbox's share of the desktop appearance.
#
...
if grep -Fq '<h1>Buzzbox</h1>' "$landing_page"; then
...
grep -Fq 'RUN kasm-patch "Buzzbox"' "$project_dir/Dockerfile"
...
echo "Buzzbox desktop branding is valid."
